...
#********************************
user_response = openapi.Response('response description', serializers_custom.CustomRoutesDefaultSerializerInterest)
@swagger_auto_schema(
    operation_description='GET sub_dashboard interests of all users',
    methods=['GET'],
...
def route(request):
    ...
    if request.method=="GET":
        ...
        try:
            ...
            #USERS
            response_data=app_subdashboard_models.Interest.objects.all()
