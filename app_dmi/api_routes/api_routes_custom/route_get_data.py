...
class RequestSerializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_data_request"
...
class Response200Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_data_response200"
...
class Response400Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_data_response400"
    ...
    if request.method=="GET":
        ...
        if serializer_req.is_valid():
            ...
            if valid_data_offset==None and valid_data_offset==None:
                ...
                queryset = app_main_models.Data.objects.all()[int(valid_data_offset):int(valid_data_limit)]
