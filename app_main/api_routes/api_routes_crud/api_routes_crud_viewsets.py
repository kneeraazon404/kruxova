...
# serializers
from app_main.api_routes.api_routes_crud import api_routes_crud_serializers
...
class CustomModelViewSet(viewsets.ModelViewSet):
    ...
    #    if settings_utils.helper_check_env_is_pro():
    #        return Response(status=status.HTTP_405_METHOD_NOT_ALLOWED)
    #    elif settings_utils.helper_check_env_is_local():
...
class GroupViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.Group.objects.all()
...
class LocationViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.Location.objects.select_related("level")
...
class LocationHierarchyLevelViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.LocationHierarchyLevel.objects.all()
...
class ValueTypeViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.ValueType.objects.all()
...
class FactorViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.Factor.objects.all()
...
class DatasourceViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.Datasource.objects.prefetch_related("group")
    ...
    def years_available(self, request, pk, *args, **kwargs):
        ...
        try:
            datasource = app_main_models.Datasource.objects.get(id=pk)
        ...
        entries = app_main_models.Data.objects.filter(datasource=datasource)
...
class DatasourceValuetypeViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.DatasourceValuetype.objects.all()
...
class DatasourceLocationViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.DatasourceLocation.objects.all()
...
class DatasourceSpecificIndicatorViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.DatasourceSpecificIndicator.objects.select_related(
...
class IndicatorViewSet(CustomModelViewSet):
    ...
    queryset = app_main_models.Indicator.objects.select_related(
        "factor"
    ...
    def datasources(self, request, pk, *args, **kwargs):
        ...
        """
        try:
            indicator = app_main_models.Indicator.objects.get(id=pk)
        except:
            return Response({"detail": "Indicator not found"}, status=404)
    ...
    def years_available(self, request, pk, *args, **kwargs):
        ...
        entries = app_main_models.Data.objects.filter(indicator=indicator)
...
class DataViewSet(CustomModelViewSet):
    ...
    def indicator_set(self, request, *args, **kwargs):
        ...
        data = app_main_models.Data.objects.filter(
    ...
    def disaggregated(self, request, *args, **kwargs):
        ...
        if request.method == "GET":
            disaggregated_data = (
                app_main_models.DisaggregatedData.objects.all().select_related()
            )
    ...
    def latest(self, request, *args, **kwargs):
        ...
        """
        latest_data = app_main_models.Data.objects.last()
...
class SubscriberViewSet(viewsets.ModelViewSet):
    ...
    queryset = app_main_models.Subscriber.objects.all()


class DashboardViewSet(viewsets.ModelViewSet):
    serializer_class = api_routes_crud_serializers.DashboardSerializer
    queryset = app_main_models.Dashboard.objects.all()
