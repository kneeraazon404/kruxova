...
class GroupSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Group
        fields = "__all__"


class LocationSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Location
        fields = "__all__"


class LocationHierarchyLevelSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.LocationHierarchyLevel
        fields = "__all__"
...
class ValueTypeSerializer(serializers.Serializer):
    ...
    class Meta:
        model = app_main_models.ValueType


class FactorSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Factor
        fields = "__all__"


class DatasourceSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Datasource
        fields = "__all__"


class DatasourceValuetypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.DatasourceValuetype
        fields = "__all__"


class DatasourceLocationSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.DatasourceLocation
        fields = "__all__"


class IndicatorSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Indicator
        fields = "__all__"


class IndicatorValuetypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.IndicatorValuetype
        fields = "__all__"


class DatasourceSpecificIndicatorSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.DatasourceSpecificIndicator
        fields = "__all__"


class LinkSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Link
        fields = "__all__"
...
class DisaggregatedDataSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.DisaggregatedData
        fields = "__all__"


class SubscriberSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Subscriber
        fields = "__all__"
...
class DashboardSerializer(serializers.ModelSerializer):
    class Meta:
        model = app_main_models.Dashboard
        fields = "__all__"
