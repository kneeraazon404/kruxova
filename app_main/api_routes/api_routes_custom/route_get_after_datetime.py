...
class Response200Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_after_datetime_response200"
...
class Response400Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_after_datetime_response400"
...
def route(request):
    ...
    if request.method=="GET":
        ...
        try:
            ...
            queryset_data_created = app_main_models.Data.objects.filter(
            ...
            queryset_data_updated = app_main_models.Data.objects.filter(
