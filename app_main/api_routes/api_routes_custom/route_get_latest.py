...
class Response200Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_last_update_response200"
...
class Response400Serializer(serializers.Serializer):
    ...
    class Meta:
        ref_name = "app_main_get_last_update_response400"
...
def route(request):
    ...
    if request.method=="GET":
        ...
        queryset = app_main_models.Data.objects.order_by('updated_at').last()
