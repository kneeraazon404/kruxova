...
urlpatterns = [
    ...
    path("api/caches/", include("app_data_caches.urls")),
    path("api/legacy/", include("app_legacy.urls")),
    path("api/dmi/", include("app_dmi.urls")),
    path("api/", include("app_user.urls")),
    path("api/subdashboard/", include("app_subdashboard.urls")),
]
