...
from app_data_caches import tasks
...
def can_refresh():
    ...
    """
    caches=app_data_caches_models.DataCacheStatus.objects.all()
    ...
    if len(caches)==0:
        ...
        for cache in caches:
            if cache.status==app_data_caches_models.CHOICES_STATUS_INPROGRESS:
                return False
